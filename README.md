...
[Download the Newest Release!](https://github.com/TrnsltLife/JiMEditor/releases/tag/v0.37)! New: You can now translate the persistent text of a Text Event. Previous newest feature: You can now specify the Starting Position for Heroes precisely. And you can indicate how much a Hero can Scout at the start of a Scenario and at the start of the Action Phase! 
