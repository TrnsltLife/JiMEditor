...
namespace JiME.Models
{
    ...
    {
        public static readonly Collection CORE_SET = new Collection("Core Set", "Ring",
        ...
        public static readonly Collection VILLAINS_OF_ERIADOR = new Collection("Villains of Eriador", "Wolf",
        ...
        public static readonly Collection SHADOWED_PATHS = new Collection("Shadowed Paths", "Web",
        ...
        public static readonly Collection DWELLERS_IN_DARKNESS = new Collection("Dwellers in Darkness", "Crown",
        ...
        public static readonly Collection SPREADING_WAR = new Collection("Spreading War", "Scepter",
        ...
        Collection(string name, string symbol, string[] monsterNames, int[] monsterIds, int[] monsterCosts, int[] monsterCounts, int[] groupLimits, int[] tileNumbers, Boolean difficultGround, Boolean fortified) =>
            (Name, Symbol, MonsterNames, MonsterIds, MonsterCosts, MonsterCounts, GroupLimits, TileNumbers, DifficultGround, Fortified) = 
            (name, symbol, monsterNames, monsterIds, monsterCosts, monsterCounts, groupLimits, tileNumbers, difficultGround, fortified);
